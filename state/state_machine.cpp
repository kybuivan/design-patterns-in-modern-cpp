...
public:
    ...
    virtual string toString() const { return "Ready state"; }
};
...
public:
    ...
    virtual void selectProduct(VendingMachine& machine);
    virtual void dispenseProduct(VendingMachine& machine);
    virtual string toString() const { return "Coin inserted state"; }
};
...
public:
    ...
    virtual void selectProduct(VendingMachine& machine);
    virtual void dispenseProduct(VendingMachine& machine);
    virtual string toString() const { return "Product selected state"; }
};
...
public:
    ...
    virtual void selectProduct(VendingMachine& machine);
    virtual void dispenseProduct(VendingMachine& machine);
    virtual string toString() const { return "Product dispensed state"; }
};
...
public:
    ...
    int getProductCount() const { return m_productCount; }
    void setProductCount(int productCount) { m_productCount = productCount; }
    State* getReadyState() const { return m_readyState; }
    State* getCoinInsertedState() const { return m_coinInsertedState; }
    State* getProductSelectedState() const { return m_productSelectedState; }
    State* getProductDispensedState() const { return m_productDispensedState; }
