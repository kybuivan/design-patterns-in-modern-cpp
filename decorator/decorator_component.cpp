...
public:
    ...
    double GetCost() const override { return 0.5 + component_->GetCost(); }
...
public:
    ...
    double GetCost() const override { return 0.3 + component_->GetCost(); }
...
int main() {
    ...
    Milk milk(&coffee);
    Sugar sugar(&milk);
    std::cout << sugar.GetDescription() << " costs $" << sugar.GetCost()
                        << std::endl;
    return 0;
}
