...
public:
    ...
    void toast() const
    {
        std::cout << "The sandwich contains " << m_bread << " bread, " << m_meat << " sauce, " << m_cheese
                  << " cheese, " << m_sauce << " sauce." << std::endl;
    }
...
public:
    ...
    {
        m_sandwich->setBread("Oregano");
    }
    void buildMeat() override
    {
        m_sandwich->setMeat("Pepperoni");
    }
    void buildCheese() override
    {
        m_sandwich->setCheese("Emmental");
    }
    void buildSauce() override
    {
        m_sandwich->setSauce("Sweet");
    }
};
...
public:
    ...
    void buildBread() override
    {
        m_sandwich->setBread("Whole grain");
    }
    void buildMeat() override
    {
        m_sandwich->setMeat("Tuna");
    }
    void buildCheese() override
    {
        m_sandwich->setCheese("Cheddar");
    }
    void buildSauce() override
    {
        m_sandwich->setSauce("Mayonaise");
    }
};
